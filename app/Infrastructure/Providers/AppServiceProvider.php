...
use App\Infrastructure\Persistence\BatchRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(TankTypeRepositoryInterface::class, TankTypeRepository::class);
        ...
        $this->app->bind(GrowthCurveRepositoryInterface::class, GrowthCurveRepository::class);
