...
class BatchController
{
     ...
     *             @OA\Property(property="tankId", type="string", format="uuid", description="ID do tanque"),
     *             @OA\Property(property="name", type="string", maxLength=255, description="Nome do lote"),
     *             @OA\Property(property="description", type="string", nullable=true, description="Descrição"),
     *             @OA\Property(property="entryDate", type="string", format="date", example="2025-01-15"),
     *             @OA\Property(property="initialQuantity", type="integer", minimum=1, description="Quantidade inicial de peixes"),
     ...
     *     description="Registra a colheita e finaliza o lote. Retorna relatório final com desempenho biológico e financeiro.",
     *     tags={"Batches"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(name="id", in="path", required=true, description="UUID do lote", @OA\Schema(type="string", format="uuid")),
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"total_weight","price_per_kg"},
     *             @OA\Property(property="total_weight", type="number", format="float", minimum=0, example=1250.5, description="Peso total da despesca (kg). Aceita também totalWeight."),
     *             @OA\Property(property="price_per_kg", type="number", format="float", minimum=0, example=12.00, description="Preço por kg (R$). Aceita também pricePerKg."),
     *             @OA\Property(property="harvest_date", type="string", format="date", nullable=true, example="2025-03-10", description="Data da despesca (Y-m-d). Opcional; usa data atual se omitido. Aceita também harvestDate.")
     *         )
     *     ),
     *     @OA\Response(response=200, description="Lote finalizado com relatório (identity, biologicalPerformance, financialPerformance)"),
